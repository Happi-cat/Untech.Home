...
namespace Untech.FinancePlanner.Domain.Views
{
	...
	public class AnnualFinancialReportMonth
	{
		...
		public static AnnualFinancialReportMonth Create(DateTime month,
			IEnumerable<AnnualFinancialReportMonthEntry> entries)
		{
			if (entries == null) throw new ArgumentNullException(nameof(entries));

			var report = new AnnualFinancialReportMonth(month.AsMonthDate())
			{
				Entries = entries
